...
const WorkerDashboard = () => {
  ...
  if (loading) return <RoleLayout title="Dashboard" hideBreadcrumbs hideHeader><div className="loading-card">Loading dashboard…</div></RoleLayout>;
  if (error && !profile) return <RoleLayout title="Dashboard" hideBreadcrumbs hideHeader><div className="alert error" role="alert">{error}</div><button className="button button-primary" type="button" onClick={() => load()}>Try again</button></RoleLayout>;
